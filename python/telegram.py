...
# https: // api.telegram.org/bot1262411978: AAGyZ_duiUu8q5QgJEbn4TFwgMW1XvB9nz8/getUpdates
...
TOKEN = "1262411978:AAGyZ_duiUu8q5QgJEbn4TFwgMW1XvB9nz8"  # Cambialo por tu token
...
def keyboard(idchat):
    keyboard = {'keyboard': [
        [{'Luz': 'text1'}], [{'Humedad Ambiente': 'text2'}],
        [{'Temperatura Ambiente': 'text1'}], [{'Temperatura Suelo': 'text2'}],
        [{'Humedad Suelo': 'text1'}], [{'Sorpresa': 'text2'}]]}
    key = json.JSONEncoder().encode(keyboard)
    requests.get(URL + "sendMessage?text=" + texto +
                 "&chat_id=" + str(idchat)+'&reply_markup='+key)
