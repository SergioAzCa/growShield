...
def state(seedNames, data_seed, datatime_now, cursor):
    ...
    cursor.execute("INSERT INTO ""dataseed1"".""state"" (typegrow,state,date)  VALUES (%s, %s, %s)",
                   (str(seedNames["seed1"]), estado, datatime_now))

    estado = waterPump(data_seed["humidity_soil2"])
    cursor.execute("INSERT INTO ""dataseed1"".""state"" (typegrow,state,date)  VALUES (%s, %s, %s)",
                   (str(seedNames["seed2"]), estado, datatime_now))

    estado = waterPump(data_seed["humidity_soil3"])
    cursor.execute("INSERT INTO ""dataseed1"".""state"" (typegrow,state,date)  VALUES (%s, %s, %s)",
                   (str(seedNames["seed3"]), estado, datatime_now))

    estado = waterPump(data_seed["humidity_soil4"])
    cursor.execute("INSERT INTO ""dataseed1"".""state"" (typegrow,state,date)  VALUES (%s, %s, %s)",
                   (str(seedNames["seed4"]), estado, datatime_now))

    estado = waterPump(data_seed["humidity_soil5"])
    cursor.execute("INSERT INTO ""dataseed1"".""state"" (typegrow,state,date)  VALUES (%s, %s, %s)",
                   (str(seedNames["seed5"]), estado, datatime_now))
